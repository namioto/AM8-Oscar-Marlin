...
#define STRING_CONFIG_H_AUTHOR "(canelia)" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_TT_OSCAR
#endif
...
#define CUSTOM_MACHINE_NAME "DS's AM8"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define  DEFAULT_Kp 10.58
    #define  DEFAULT_Ki 0.64
    #define  DEFAULT_Kd 61.57  
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 181.28
  #define DEFAULT_bedKi 22.13
  #define DEFAULT_bedKd 990.06
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 79.5f, 79.7f, 400.0f, 85.0f }
...
#define X_MIN_POS -28.8f
#define Y_MIN_POS -3.8f
#define Z_MIN_POS 0
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { -1, -1, 3 }
